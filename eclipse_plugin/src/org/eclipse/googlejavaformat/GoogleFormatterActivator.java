...
public class GoogleFormatterActivator extends AbstractUIPlugin {

  public static final String PLUGIN_ID = "google-java-format-eclipse-plugin";

  private static GoogleFormatterActivator plugin;

  public GoogleFormatterActivator() {}
  ...
  public static GoogleFormatterActivator getDefault() {
    return plugin;
  }
  ...
  private static void log(int status, String message, Throwable throwable) {
    getDefault()
        ...
        .log(
            new OperationStatus(
                status, GoogleFormatterActivator.PLUGIN_ID, Status.OK, message, throwable));
  }
}
